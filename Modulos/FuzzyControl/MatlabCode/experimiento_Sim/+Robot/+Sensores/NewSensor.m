classdef NewSensor
    ...
    methods
        ...
        function obj = TrasladarYRotar(obj)     % Rota y traslada el cono 
            ...
            obj.Xrot =  (obj.X-obj.ubicacion(1))*cosd(obj.rotacion) + (obj.Y-obj.ubicacion(2))*sind(obj.rotacion) + obj.ubicacion(1);
            obj.Yrot = -(obj.X-obj.ubicacion(1))*sind(obj.rotacion) + (obj.Y-obj.ubicacion(2))*cosd(obj.rotacion) + obj.ubicacion(2);
        end
    end
end
