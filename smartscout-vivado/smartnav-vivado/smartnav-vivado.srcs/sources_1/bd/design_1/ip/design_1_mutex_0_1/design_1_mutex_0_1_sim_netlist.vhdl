...
-- Date        : Sat Feb 11 16:42:14 2023
-- Host        : kuhiu-Aspire-A515-51G running 64-bit Ubuntu 18.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/user/project/smartnav-vivado.srcs/sources_1/bd/design_1/ip/design_1_mutex_0_1/design_1_mutex_0_1_sim_netlist.vhdl
...
entity design_1_mutex_0_1_axi_decode is
  port (
    ...
    \Mutex_Addr_I_reg[5]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute ORIG_REF_NAME of design_1_mutex_0_1_axi_decode : entity is "axi_decode";
end design_1_mutex_0_1_axi_decode;

architecture STRUCTURE of design_1_mutex_0_1_axi_decode is
  signal CE : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Mutex_Addr_I[5]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[6]_i_1\ : label is "soft_lutpair14";
...
\Mutex_Wr_Data_I[23]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_mutex_0_1_axi_decode__parameterized1\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_mutex_0_1_axi_decode__parameterized1\ : entity is "axi_decode";
end \design_1_mutex_0_1_axi_decode__parameterized1\;

architecture STRUCTURE of \design_1_mutex_0_1_axi_decode__parameterized1\ is
  signal CE : STD_LOGIC;
  signal Mutex_Access_I0 : STD_LOGIC;
  ...
  signal \Mutex_Wr_Data_I[23]_i_1__0_n_0\ : STD_LOGIC;
  signal R : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Mutex_Addr_I[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \Mutex_Addr_I[6]_i_1\ : label is "soft_lutpair16";
  attribute box_type : string;
  attribute box_type of \S_AXI_RDATA_DFF[0].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute box_type of \S_AXI_RDATA_DFF[1].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute box_type of \S_AXI_RDATA_DFF[2].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  ...
  attribute box_type of \S_AXI_RDATA_DFF[7].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute box_type of \S_AXI_RDATA_DFF[8].S_AXI_RDATA_FDRE\ : label is "PRIMITIVE";
  attribute SOFT_HLUTNM of new_read_access_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of new_write_access_cmb : label is "soft_lutpair15";
begin
...
\Mutex_Addr_I_reg[5]\: unisim.vcomponents.FDRE
     port map (
      ...
      D => \Mutex_Addr_I[5]_i_1_n_0\,
      Q => \Mutex_Addr_I_reg[5]_0\(1),
      R => \Mutex_Wr_Data_I[23]_i_1__0_n_0\
    );
\Mutex_Addr_I_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => S1_AXI_ACLK,
...
\Mutex_Wr_Data_I[23]_i_1__0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => S1_AXI_ARESETN,
      O => \Mutex_Wr_Data_I[23]_i_1__0_n_0\
    );
\Mutex_Wr_Data_I[23]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_mutex_0_1_multi_channel_register is
  port (
    ...
    S0_AXI_ACLK : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 8 downto 0 );
    \Mutex_Rd_Data_reg[31]\ : in STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_mutex_0_1_multi_channel_register : entity is "multi_channel_register";
end design_1_mutex_0_1_multi_channel_register;

architecture STRUCTURE of design_1_mutex_0_1_multi_channel_register is
  ...
  attribute SOFT_HLUTNM of \Use_Single_Ch_Reg.Data_Out[1]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Use_Single_Ch_Reg.Data_Out[2]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Use_Single_Ch_Reg.Data_Out[3]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Use_Single_Ch_Reg.Data_Out[4]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \Use_Single_Ch_Reg.Data_Out[5]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \Use_Single_Ch_Reg.Data_Out[7]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \Use_Single_Ch_Reg.Data_Out[8]_i_2\ : label is "soft_lutpair6";
...
\Mutex_Rd_Data[23]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
        ...
        port map (
      I0 => \Mutex_Rd_Data_reg[31]\(0),
      I1 => p_1_in(7),
      I2 => \Mutex_Rd_Data_reg[31]\(1),
      O => D(8)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_mutex_0_1_multi_channel_mutex is
  port (
    SR : out STD_LOGIC_VECTOR ( 0 to 0 );
    D : out STD_LOGIC_VECTOR ( 8 downto 0 );
    S0_AXI_ARESETN : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_mutex_0_1_multi_channel_mutex : entity is "multi_channel_mutex";
end design_1_mutex_0_1_multi_channel_mutex;

architecture STRUCTURE of design_1_mutex_0_1_multi_channel_mutex is
begin
Mutex_Store: entity work.design_1_mutex_0_1_multi_channel_register
     port map (
      D(8 downto 0) => D(8 downto 0),
      E(0) => E(0),
      \Mutex_Rd_Data_reg[31]\(1 downto 0) => \Mutex_Rd_Data_reg[31]\(1 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_mutex_0_1_mutex_core is
  port (
    Rst : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_mutex_0_1_mutex_core : entity is "mutex_core";
end design_1_mutex_0_1_mutex_core;

architecture STRUCTURE of design_1_mutex_0_1_mutex_core is
  ...
  signal \No_HW_Protection.Normal_Mutex_Inst_n_9\ : STD_LOGIC;
  ...
  signal \Using_MultiIf_Mutex.Mutex_Addr_I_reg_n_0_[6]\ : STD_LOGIC;
  signal \Using_MultiIf_Mutex.Mutex_RnW_I_reg_n_0\ : STD_LOGIC;
  signal \Using_MultiIf_Mutex.Mutex_Wr_Data_I[23]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Addr_I[6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[23]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[24]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[25]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[26]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[27]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[28]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[29]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[30]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \Using_MultiIf_Mutex.Mutex_Wr_Data_I[31]_i_1\ : label is "soft_lutpair9";
begin
...
\Mutex_Rd_Data_reg[31]\: unisim.vcomponents.FDRE
     port map (
      C => S0_AXI_ACLK,
      CE => Second_Cycle,
      D => \No_HW_Protection.Normal_Mutex_Inst_n_9\,
      Q => Q(0),
      R => \^rst\
    );
\No_HW_Protection.Normal_Mutex_Inst\: entity work.design_1_mutex_0_1_multi_channel_mutex
     port map (
      D(8) => \No_HW_Protection.Normal_Mutex_Inst_n_1\,
      D(7) => \No_HW_Protection.Normal_Mutex_Inst_n_2\,
      D(6) => \No_HW_Protection.Normal_Mutex_Inst_n_3\,
      D(5) => \No_HW_Protection.Normal_Mutex_Inst_n_4\,
      D(4) => \No_HW_Protection.Normal_Mutex_Inst_n_5\,
      D(3) => \No_HW_Protection.Normal_Mutex_Inst_n_6\,
      D(2) => \No_HW_Protection.Normal_Mutex_Inst_n_7\,
      D(1) => \No_HW_Protection.Normal_Mutex_Inst_n_8\,
      D(0) => \No_HW_Protection.Normal_Mutex_Inst_n_9\,
      E(0) => Write_Strobe,
      \Mutex_Rd_Data_reg[31]\(1) => \Read_Data_Type_reg_n_0_[0]\,
      \Mutex_Rd_Data_reg[31]\(0) => \Read_Data_Type_reg_n_0_[1]\,
      Q(8 downto 0) => Mutex_Wr_Data_I(8 downto 0),
      S0_AXI_ACLK => S0_AXI_ACLK,
      S0_AXI_ARESETN => S0_AXI_ARESETN,
      SR(0) => \^rst\
    );
...
\Read_Data_Type_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => S0_AXI_ACLK,
      CE => '1',
      D => \Using_MultiIf_Mutex.Mutex_Addr_I_reg_n_0_[6]\,
...
\Using_MultiIf_Mutex.Mutex_Addr_I_reg[6]\: unisim.vcomponents.FDRE
     port map (
      ...
      Q => \Using_MultiIf_Mutex.Mutex_Addr_I_reg_n_0_[6]\,
      R => \^rst\
    );
...
\Using_MultiIf_Mutex.Mutex_Wr_Data_I[23]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      ...
      I1 => Mutex_Access,
      I2 => Mutex_Wr_Data(8),
      O => \Using_MultiIf_Mutex.Mutex_Wr_Data_I[23]_i_2_n_0\
    );
...
\Using_MultiIf_Mutex.Mutex_Wr_Data_I_reg[23]\: unisim.vcomponents.FDRE
     port map (
      C => S0_AXI_ACLK,
      CE => E(0),
      D => \Using_MultiIf_Mutex.Mutex_Wr_Data_I[23]_i_2_n_0\,
      Q => Mutex_Wr_Data_I(8),
      R => \^rst\
    );
...
Write_Strobe_Mutex_i_1: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => \^using_multiif_mutex.access_in_progress_reg_0\,
      I2 => S0_AXI_ARESETN,
      I3 => \Using_MultiIf_Mutex.Mutex_Addr_I_reg_n_0_[6]\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_mutex_0_1_mutex is
  port (
    S0_AXI_ACLK : in STD_LOGIC;
    S0_AXI_ARESETN : in STD_LOGIC;
  ...
  attribute C_ASYNC_CLKS of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_ENABLE_HW_PROT : integer;
  attribute C_ENABLE_HW_PROT of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_ENABLE_USER : integer;
  attribute C_ENABLE_USER of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_FAMILY : string;
  attribute C_FAMILY of design_1_mutex_0_1_mutex : entity is "zynq";
  attribute C_NUM_AXI : integer;
  attribute C_NUM_AXI of design_1_mutex_0_1_mutex : entity is 2;
  attribute C_NUM_MUTEX : integer;
  attribute C_NUM_MUTEX of design_1_mutex_0_1_mutex : entity is 1;
  attribute C_NUM_SYNC_FF : integer;
  attribute C_NUM_SYNC_FF of design_1_mutex_0_1_mutex : entity is 2;
  attribute C_OWNER_ID_WIDTH : integer;
  attribute C_OWNER_ID_WIDTH of design_1_mutex_0_1_mutex : entity is 8;
  attribute C_S0_AXI_ADDR_WIDTH : integer;
  attribute C_S0_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S0_AXI_BASEADDR : integer;
  attribute C_S0_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is 1130364928;
  attribute C_S0_AXI_DATA_WIDTH : integer;
  attribute C_S0_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S0_AXI_HIGHADDR : integer;
  attribute C_S0_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 1130430463;
  attribute C_S1_AXI_ADDR_WIDTH : integer;
  attribute C_S1_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S1_AXI_BASEADDR : integer;
  attribute C_S1_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is 1128267776;
  attribute C_S1_AXI_DATA_WIDTH : integer;
  attribute C_S1_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S1_AXI_HIGHADDR : integer;
  attribute C_S1_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 1128333311;
  attribute C_S2_AXI_ADDR_WIDTH : integer;
  attribute C_S2_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S2_AXI_BASEADDR : integer;
  attribute C_S2_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is -1;
  attribute C_S2_AXI_DATA_WIDTH : integer;
  attribute C_S2_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S2_AXI_HIGHADDR : integer;
  attribute C_S2_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_S3_AXI_ADDR_WIDTH : integer;
  attribute C_S3_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S3_AXI_BASEADDR : integer;
  attribute C_S3_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is -1;
  attribute C_S3_AXI_DATA_WIDTH : integer;
  attribute C_S3_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S3_AXI_HIGHADDR : integer;
  attribute C_S3_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_S4_AXI_ADDR_WIDTH : integer;
  attribute C_S4_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S4_AXI_BASEADDR : integer;
  attribute C_S4_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is -1;
  attribute C_S4_AXI_DATA_WIDTH : integer;
  attribute C_S4_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S4_AXI_HIGHADDR : integer;
  attribute C_S4_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_S5_AXI_ADDR_WIDTH : integer;
  attribute C_S5_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S5_AXI_BASEADDR : integer;
  attribute C_S5_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is -1;
  attribute C_S5_AXI_DATA_WIDTH : integer;
  attribute C_S5_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S5_AXI_HIGHADDR : integer;
  attribute C_S5_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_S6_AXI_ADDR_WIDTH : integer;
  attribute C_S6_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S6_AXI_BASEADDR : integer;
  attribute C_S6_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is -1;
  attribute C_S6_AXI_DATA_WIDTH : integer;
  attribute C_S6_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S6_AXI_HIGHADDR : integer;
  attribute C_S6_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 0;
  attribute C_S7_AXI_ADDR_WIDTH : integer;
  attribute C_S7_AXI_ADDR_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S7_AXI_BASEADDR : integer;
  attribute C_S7_AXI_BASEADDR of design_1_mutex_0_1_mutex : entity is -1;
  attribute C_S7_AXI_DATA_WIDTH : integer;
  attribute C_S7_AXI_DATA_WIDTH of design_1_mutex_0_1_mutex : entity is 32;
  attribute C_S7_AXI_HIGHADDR : integer;
  attribute C_S7_AXI_HIGHADDR of design_1_mutex_0_1_mutex : entity is 0;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_mutex_0_1_mutex : entity is "mutex";
end design_1_mutex_0_1_mutex;

architecture STRUCTURE of design_1_mutex_0_1_mutex is
...
SingleAccess: entity work.design_1_mutex_0_1_mutex_core
     port map (
...
\Using_AXI_0.AXI_If_0\: entity work.design_1_mutex_0_1_axi_decode
     port map (
      Mutex_Access => Mutex_Access,
      Mutex_Ack(0) => Mutex_Ack(0),
      \Mutex_Addr_I_reg[5]_0\(1) => Mutex_Addr(5),
      \Mutex_Addr_I_reg[5]_0\(0) => Mutex_Addr(6),
...
\Using_AXI_1.AXI_If_1\: entity work.\design_1_mutex_0_1_axi_decode__parameterized1\
     port map (
      E(0) => \Using_AXI_1.AXI_If_1_n_15\,
      Mutex_Access => Mutex_Access,
      Mutex_Access_I_reg_0 => \Using_AXI_1.AXI_If_1_n_11\,
      Mutex_Ack(0) => Mutex_Ack(1),
      \Mutex_Addr_I_reg[5]_0\(1) => Mutex_Addr(14),
      \Mutex_Addr_I_reg[5]_0\(0) => Mutex_Addr(15),
...
entity design_1_mutex_0_1 is
  ...
  attribute NotValidForBitStream of design_1_mutex_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_mutex_0_1 : entity is "design_1_mutex_0_1,mutex,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_mutex_0_1 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_mutex_0_1 : entity is "mutex,Vivado 2019.1";
end design_1_mutex_0_1;

architecture STRUCTURE of design_1_mutex_0_1 is
...
begin
U0: entity work.design_1_mutex_0_1_mutex
     port map (
      S0_AXI_ACLK => S0_AXI_ACLK,
