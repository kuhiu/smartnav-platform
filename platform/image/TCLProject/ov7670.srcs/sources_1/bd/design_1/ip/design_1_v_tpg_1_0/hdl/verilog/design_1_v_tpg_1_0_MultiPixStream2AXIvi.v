...
module design_1_v_tpg_1_0_MultiPixStream2AXIvi (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [9:0] j_0_reg_255;
reg    ap_block_state1;
wire   [9:0] trunc_ln850_1_fu_287_p1;
reg   [9:0] trunc_ln850_1_reg_566;
...
wire   [8:0] trunc_ln915_fu_291_p1;
reg   [8:0] trunc_ln915_reg_571;
wire   [10:0] add_ln915_fu_295_p2;
reg   [10:0] add_ln915_reg_576;
...
wire   [9:0] j_fu_390_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] tmp_last_V_fu_396_p2;
reg   [0:0] tmp_last_V_reg_631;
wire   [0:0] tmp_user_V_load_load_fu_401_p1;
wire   [23:0] tmp_data_V_fu_485_p5;
...
wire   [10:0] trunc_ln850_fu_283_p1;
...
wire   [10:0] zext_ln898_fu_381_p1;
wire   [23:0] p_Result_s_fu_448_p3;
wire   [23:0] p_Result_4_fu_440_p3;
wire   [7:0] select_ln941_2_fu_470_p3;
wire   [7:0] select_ln941_1_fu_463_p3;
wire   [23:0] select_ln941_fu_456_p3;
wire   [15:0] tmp_4_fu_477_p3;
wire   [0:0] fid_toggle_fu_506_p1;
wire   [0:0] and_ln983_fu_510_p2;
wire   [0:0] fid_toggle_1_fu_520_p2;
wire   [0:0] or_ln983_1_fu_515_p2;
wire   [0:0] select_ln996_fu_526_p3;
reg   [4:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
design_1_v_tpg_1_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_266(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
design_1_v_tpg_1_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_272(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (m_axis_video_TREADY == 1'b0))) & (icmp_ln893_fu_370_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_user_V_load_load_fu_401_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((2'd1 == AXI_video_strm_V_dest_V_1_state) | (2'd1 == AXI_video_strm_V_id_V_1_state) | (2'd1 == AXI_video_strm_V_last_V_1_state) | (2'd1 == AXI_video_strm_V_user_V_1_state) | (2'd1 == AXI_video_strm_V_strb_V_1_state) | (2'd1 == AXI_video_strm_V_keep_V_1_state) | (2'd1 == AXI_video_strm_V_data_V_1_state) | ((2'd3 == AXI_video_strm_V_data_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_dest_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_id_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_last_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_user_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_strb_V_1_state) & (m_axis_video_TREADY == 1'b0)) | ((2'd3 == AXI_video_strm_V_keep_V_1_state) & (m_axis_video_TREADY == 1'b0))) & (icmp_ln893_fu_370_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        j_0_reg_255 <= 10'd0;
    end else if (((icmp_ln898_fu_385_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_0_reg_255 <= j_fu_390_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln898_reg_622 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_data_V_1_load_A)) begin
        AXI_video_strm_V_data_V_1_payload_A <= tmp_data_V_fu_485_p5;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_data_V_1_load_B)) begin
        AXI_video_strm_V_data_V_1_payload_B <= tmp_data_V_fu_485_p5;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_last_V_1_load_A)) begin
        AXI_video_strm_V_last_V_1_payload_A <= tmp_last_V_reg_631;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_last_V_1_load_B)) begin
        AXI_video_strm_V_last_V_1_payload_B <= tmp_last_V_reg_631;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_user_V_1_load_A)) begin
        AXI_video_strm_V_user_V_1_payload_A <= tmp_user_V_fu_160;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == AXI_video_strm_V_user_V_1_load_B)) begin
        AXI_video_strm_V_user_V_1_payload_B <= tmp_user_V_fu_160;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state2_on_subcall_done) & (1'b1 == ap_CS_fsm_state2))) begin
        add_ln915_reg_576 <= add_ln915_fu_295_p2;
        trunc_ln850_1_reg_566 <= trunc_ln850_1_fu_287_p1;
        trunc_ln915_reg_571 <= trunc_ln915_fu_291_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln898_fu_385_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_631 <= tmp_last_V_fu_396_p2;
    end
end
...
always @ (*) begin
    if (((icmp_ln898_reg_622_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        fid_ap_vld = 1'b1;
    end else begin
        fid_ap_vld = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln898_fu_385_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln898_fu_385_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign add_ln915_fu_295_p2 = ($signed(11'd2047) + $signed(trunc_ln850_fu_283_p1));
...
assign and_ln983_fu_510_p2 = (xor_ln983_fu_341_p2 & fid_toggle_fu_506_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln898_reg_622 == 1'd0) & (io_acc_block_signal_op62 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln898_reg_622 == 1'd0) & (io_acc_block_signal_op62 == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln898_reg_622 == 1'd0) & (io_acc_block_signal_op62 == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state5_io = ((icmp_ln898_reg_622 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((icmp_ln898_reg_622 == 1'd0) & (io_acc_block_signal_op62 == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((icmp_ln898_reg_622_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign fid = ((icmp_ln983_1_fu_353_p2[0:0] === 1'b1) ? or_ln983_1_fu_515_p2 : select_ln996_fu_526_p3);

assign fid_toggle_1_fu_520_p2 = (fid_toggle_fu_506_p1 ^ 1'd1);

assign fid_toggle_fu_506_p1 = counter_loc_0_fu_164[0:0];
...
assign i_fu_375_p2 = (i_0_reg_244 + 9'd1);
...
assign icmp_ln898_fu_385_p2 = ((j_0_reg_255 == trunc_ln850_1_reg_566) ? 1'b1 : 1'b0);
...
assign io_acc_block_signal_op62 = (strmPix_V_val_2_V_empty_n & strmPix_V_val_1_V_empty_n & strmPix_V_val_0_V_empty_n);

assign j_fu_390_p2 = (j_0_reg_255 + 10'd1);
...
assign or_ln983_1_fu_515_p2 = (xor_ln983_1_fu_347_p2 | and_ln983_fu_510_p2);

assign or_ln983_fu_335_p2 = (icmp_ln987_fu_307_p2 | icmp_ln983_fu_301_p2);

assign p_Result_4_fu_440_p3 = {{16'd65535}, {strmPix_V_val_0_V_dout}};

assign p_Result_s_fu_448_p3 = {{16'd65535}, {strmPix_V_val_1_V_dout}};

assign select_ln941_1_fu_463_p3 = ((icmp_ln941_fu_359_p2[0:0] === 1'b1) ? strmPix_V_val_2_V_dout : strmPix_V_val_1_V_dout);

assign select_ln941_2_fu_470_p3 = ((icmp_ln941_fu_359_p2[0:0] === 1'b1) ? strmPix_V_val_0_V_dout : strmPix_V_val_2_V_dout);

assign select_ln941_fu_456_p3 = ((icmp_ln941_fu_359_p2[0:0] === 1'b1) ? p_Result_s_fu_448_p3 : p_Result_4_fu_440_p3);

assign select_ln996_fu_526_p3 = ((icmp_ln996_fu_313_p2[0:0] === 1'b1) ? fid_toggle_1_fu_520_p2 : and_ln1001_fu_325_p2);

assign tmp_4_fu_477_p3 = {{select_ln941_2_fu_470_p3}, {select_ln941_1_fu_463_p3}};

assign tmp_data_V_fu_485_p5 = {{tmp_4_fu_477_p3}, {select_ln941_fu_456_p3[7:0]}};

assign tmp_last_V_fu_396_p2 = ((zext_ln898_fu_381_p1 == add_ln915_reg_576) ? 1'b1 : 1'b0);

assign tmp_user_V_load_load_fu_401_p1 = tmp_user_V_fu_160;

assign trunc_ln850_1_fu_287_p1 = grp_reg_unsigned_short_s_fu_272_ap_return[9:0];

assign trunc_ln850_fu_283_p1 = grp_reg_unsigned_short_s_fu_272_ap_return[10:0];

assign trunc_ln915_fu_291_p1 = grp_reg_unsigned_short_s_fu_266_ap_return[8:0];
...
endmodule //design_1_v_tpg_1_0_MultiPixStream2AXIvi
