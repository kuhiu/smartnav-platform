...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconcat_v2_1_3 -L v_frmbuf_wr_v2_1_2 -L v_csc_v1_0_13 -L xlslice_v1_0_2 -L v_demosaic_v1_0_5 -L v_vid_in_axi4s_v4_0_9 -L xlconstant_v1_1_6 -L util_vector_logic_v2_0_1 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_d92b.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
