...
int main(void)
{
  ...
  rule_7           = add_rule(rule_7, "LEJOS, LEJOS , LEJOS = CENTRO, W_BAJO, S_RAPIDA", if_side_7_left, then_side_7, NULL);
  ...
  rule_6           = add_rule(rule_6, "LEJOS, LEJOS , CERCA = CENTRO, W_ALTO, S_LENTA", if_side_6_left, then_side_6, rule_7);
  ...
  rule_5           = add_rule(rule_5, "LEJOS, CERCA , LEJOS = IZQUIERDA, W_ALTO, S_LENTA", if_side_5_left, then_side_5, rule_6);
  ...
  rule_4           = add_rule(rule_4, "LEJOS, CERCA , CERCA = IZQUIERDA, W_ALTO, S_LENTA", if_side_4_left, then_side_4, rule_5);
  ...
  rule_3           = add_rule(rule_3, "CERCA, LEJOS , LEJOS = CENTRO, W_ALTO, S_LENTA", if_side_3_left, then_side_3, rule_4);
  ...
  rule_2           = add_rule(rule_2, "CERCA, LEJOS , CERCA = CENTRO, W_ALTO, S_LENTA", if_side_2_left, then_side_2, rule_3);
  ...
  rule_1           = add_rule(rule_1, "CERCA, CERCA , LEJOS = DERECHA, W_ALTO, S_LENTA", if_side_1_left, then_side_1, rule_2);
  ...
  rule_0           = add_rule(rule_0, "CERCA, CERCA , CERCA = IZQUIERDA, W_ALTO, S_LENTA", if_side_0_left, then_side_0, rule_1);
