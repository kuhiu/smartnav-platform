classdef navegador
    ...
    methods
        function nav = navegador()
            ...
            nav.obstacles = [ [8 5] [8 7] [8 9] [12 5] [12 7] [12 9] [12 11] [5 9] [5 11] [5 13] [5 15] [9 13] [9 15] [9 17] [9 19] [11 19] [13 19] [15 19] [11 23] [13 23] [15 23] [5 21] [5 23] [7 23] [9 23] [10 13] [11 13] [12 13] [5 17] [5 19]];
            nav.robot = [10 4 pi/2];    % El tercer argumento es la orientacion absoluta del robot al iniciar 
            nav.target = [25 25];       % Esta simulacion no tiene target
        ...
        function nav = GoToTarget(nav,d)
            ...
            % Leyenda al grafico
            legend({'Cono central', 'Cono derecho' , 'Cono izquierdo','Vehiculo', 'Obstaculo'},'Location','northwest')
            ...
            for i = 2:1000/nav.PeriodoDeSampleo
                ...
                fprintf(nav.fid,"Las distancias: %d, %d, %d , el angulo: %d , w: %d, vel: %d\n", distR_O,distC_O,distL_O, Theta, w, nav.Velocidad);
