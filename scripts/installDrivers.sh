...
sudo insmod /home/ubuntu/drivers/driver_pwm_EMIOgpio_PL_1.ko;
sudo insmod /home/ubuntu/drivers/driver_pwm_EMIOgpio_PL_2.ko;
...
echo "Run App"
sudo nohup /home/ubuntu/buttonsControl/buttonsControl > /dev/null 2>&1 &