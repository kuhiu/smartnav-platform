...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports ov7670_reset ];          #IO_L6P_T0_34 Sch=JD2_P
...
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports ov7670_powerdown ];          #IO_L21P_T3_DQS_34 Sch=JD4_P
