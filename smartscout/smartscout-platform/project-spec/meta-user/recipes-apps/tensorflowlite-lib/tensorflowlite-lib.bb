#
# This file is the libtensorflowlite recipe.
#

SUMMARY = "Simple libtensorflowlite application"
...
TARGET_CPPLAGS = "-O2"
TARGET_CXXLAGS = "-O2"
CCFLAGS = " -O3 -DNDEBUG -fPIC -DGEMMLOWP_ALLOW_SLOW_SCALAR_FALLBACK -DTFLITE_WITH_RUY -DTFLITE_WITHOUT_XNNPACK -DBUILD_WITH_NNAPI=false -I${STAGING_INCDIR}"
CXXFLAGS = " -O3 -DNDEBUG -fPIC -DGEMMLOWP_ALLOW_SLOW_SCALAR_FALLBACK -DTFLITE_WITH_RUY -DTFLITE_WITHOUT_XNNPACK -DBUILD_WITH_NNAPI=false -I${STAGING_INCDIR}"
LDFLAGS = "-Wl,-O1"
