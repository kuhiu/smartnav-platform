...
do_compile() {
	${CXX} ${CFLAGS} -O3 ${LDFLAGS} -o smartnav-app main.cpp -I${S} -li2c -ldevelop-smartnavlib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_videoio -lopencv_imgcodecs -ltensorflow-lite -ldl -lpthread  
}
